...
setup(
  name = 'MoSek',         # How you named your package folder (MyLib)
  packages = ['MoSek'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/Muhamedelsayed/MNiST/archive/V1.0.tar.gz',    # I explain this later on
